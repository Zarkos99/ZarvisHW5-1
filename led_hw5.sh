#!/bin/bash
# A small Bash script to set up User LED3 to be turned on or off from the
#  Linux console.
# This program also allows for the blinking of USRLED3 via using the command as follows:
# Example usage: led_hw5 blink 5
